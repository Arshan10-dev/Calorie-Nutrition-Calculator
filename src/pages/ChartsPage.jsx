    ...
    >
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
          Visual breakdown of your nutrition data
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        <ChartSection
          ...
          subtitle="Protein · Fat · Carbohydrates — by percentage of daily calories"
          delay={0}
        >
          <MacroPieChart />
        </ChartSection>
        ...
        <ChartSection
          title="Calorie Goal Comparison"
          subtitle="BMR, TDEE and all goal-adjusted calorie targets side by side"
          delay={0.08}
        >
      ...
      {/* Full width: Weight projection */}
      <ChartSection
        title="Weight Goal Projection"
        subtitle="Estimated timeline at ~0.5 kg per week (safe rate)"
        delay={0.16}
      >
        <WeightProgressChart />
      </ChartSection>
